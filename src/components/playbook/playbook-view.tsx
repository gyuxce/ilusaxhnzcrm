...
const STATUS_GUIDE = [
  ...
  { status: 'Waiting Result', meaning: 'Sesi/form sudah berjalan dan menunggu hasil pemetaan.', next: 'Kirim hasil pemetaan.' },
  { status: 'Sent Result Pemetaan', meaning: 'Hasil pemetaan sudah selesai dibuat dan dikirim ke lead.', next: 'Jadwalkan expert consultation.' },
