...
const COPY = {
  id: {
    ...
    kpiWin: 'Seat lock / menang',
    kpiLost: 'Lost',
    funnel: 'Alur tahap 1–6',
    funnelHint: 'Angka di setiap tahap = berapa lead yang sedang di situ.',
    wins: 'Menang minggu ini',
    lost: 'Lost minggu ini',
    topLost: 'Alasan gagal terbanyak',
    emptyLost: 'Belum ada pola alasan gagal.',
    emptyState: 'Belum ada data lead untuk ditampilkan.',
    note: 'Detail operasional (antrian harian, chat CRO) ada di menu tim — halaman ini khusus pantauan.',
    openTeam: 'Buka laporan tim',
  },
  en: {
    title: 'Client Report',
    ...
    kpiWin: 'Seat lock / won',
    kpiLost: 'Lost',
    funnel: 'Stages 1–6',
    funnelHint: 'Each stage shows how many leads are there now.',
    wins: 'Wins this week',
    lost: 'Lost this week',
    topLost: 'Top lost reasons',
    emptyLost: 'No lost-reason patterns yet.',
    emptyState: 'No lead data to show yet.',
    note: 'Daily ops (queues, CRO chat) live in the team menu — this page is monitoring only.',
    openTeam: 'Open team report',
  },
} as const
